	...
	var html = 	"<div class='heading_font'>Set_Database</div>" +
				...
				"<div class='code_font indent_2 bottom_space_2'>" +
					"&lt;?php\n" +
						...
						"\t$my_second_database = \"My_Second_Database\";\n\n" +
						"\tif($my_database->Set_Database($my_second_database))\n" +
						"\t\t echo \"New Database was set successfully.\";\n" +
						"\telse\n" +
						"\t\t echo \"New Database was not set.\";\n" +
				"</div>";
